...
-- Checking witnesses descriptions
...
SELECT license_plate FROM bakery_security_logs WHERE year = 2021 AND month = 7 AND day = 28 AND hour LIKE 10;

-- The thief drove away in a car from the bakery, within 10 minutes from the theft. SO, checking the license plates of cars within that time frame. Then, checking out the names of those cars' owners.
SELECT name, bakery_security_logs.hour, bakery_security_logs.minute
 ...
 -- Thief was withdrawing money from the ATM on Leggett Street. So, checking the account number of the person who did that transaction.
...
SELECT name, phone_calls.duration
 ...
 -- Only 2 suspects: Bruce and Diana
...
-- First flight comes out to be at 8:20 to LaGuardia Airport in NY. This could be the place where the thief went to.
...
SELECT passengers.flight_id, name, passengers.passport_number, passengers.seat
 ...
 --Bruce is the thief!
 -- Robin is the accomplice as the call duartion was the same for him and Bruce!